...
class AppColors {
  ...
  static const Color buttonTextColor =
      Colors.white; // Color blanco para los botones
}
...
class AppTextStyles {
  ...
  static TextStyle buttonTextStyle = GoogleFonts.poppins(
    fontSize: 20,
    fontWeight: FontWeight.bold,
    color: AppColors.buttonTextColor, // Color blanco para el texto del botón
  );
...
// Contenedor para los íconos de Google, Apple y Facebook
